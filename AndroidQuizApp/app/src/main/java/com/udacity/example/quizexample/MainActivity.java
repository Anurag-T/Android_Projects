...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextWord() {
        ...
        if(mData!=null) {
            if (mData.moveToNext()) {
                mWordView.setText(mData.getString(word_id));
            } else {
                Toast.makeText(this, "Starting from First", Toast.LENGTH_SHORT).show();
    ...
    public void showDefinition() {
        ...
        mDefView.setText(mData.getString(def_id));
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            // TODO (2) Initialize anything that you need the cursor for, such as setting up
             word_id = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD);
             def_id = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
            nextWord();
